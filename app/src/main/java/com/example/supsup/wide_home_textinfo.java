...
public class wide_home_textinfo extends AppCompatActivity {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() { // 참조한 위치에 데이터가 변화가 일어날 때 마다 매번 읽어옴
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (textModel.name.equals(WHelp_Me.text_name) && textModel.title.equals(WHelp_Me.text_title)) {    //해주세요
                        ...
                        textUser_name = WHelp_Me.text_name;  // frag_home_helpme 의 변수 여기다가 설정
                        text_title = WHelp_Me.text_title;    // frag_home_helpme 의 변수 여기다가 설정
